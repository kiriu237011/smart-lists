...
`main@b2a18741`: scoped DB-контур, tenant policy/column-guard объекты, live audit
trail, attachment/AI privacy-потоки, путь `prisma → @prisma/config →
deepmerge-ts` и live-профиль Preview/Production `tenant-full`
