...
runtime-валидация ответа AI-сервиса
...
| Новая известная high/critical уязвимость не добавляется незаметно | PR Dependency Review во всех scopes, read-only и без исполнения PR-кода | A54 |
