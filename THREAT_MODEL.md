...
Распределение на 2026-09-01 после первого прохода доверификации и закрытия A68 и A56: **T — 31, M — 23, — — 9, R — 7, T\* — 3**. Практический вывод в том, что почти половина реестра (30 строк: M и R) держится на доказательстве, которое устаревает без единого сигнала.
