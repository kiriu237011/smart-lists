...
Распределение на 2026-09-01 после первого прохода доверификации, закрытия A68 и A56 и появления A74: **T — 32, M — 23, — — 9, R — 7, T\* — 3** (74 строки). Практический вывод в том, что почти половина реестра (30 строк: M и R) держится на доказательстве, которое устаревает без единого сигнала.
