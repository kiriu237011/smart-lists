...
2. **Postgres least privilege и RLS:** архитектурный проект согласован
   ...
   Deployment Check, runtime без DDL, scoped-контекст и RLS ещё не внедрены.
